...
public class MultiSelectCustomFieldValidator implements ClauseValidator {
    ...
    public MultiSelectCustomFieldValidator(final CustomField customField, final JqlSelectOptionsUtil jqlSelectOptionsUtil, final JqlOperandResolver jqlOperandResolver, final I18nHelper.BeanFactory beanFactory) {
